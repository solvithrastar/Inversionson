...
class Optimize(object):
    ...
    def _pick_data_for_iteration(self):
        ...
        if self.time_for_validation():
            print("This is a validation iteration. Will add validation events to the iteration")
    ...
    def prepare_iteration(
        ...
        remote_mesh_file = self.comm.project.remote_mesh_dir / "models" / it_name / "mesh.h5"
    ...
    def compute_gradient(self, verbose=False):
        ...
        if self.time_for_validation():
            self.comm.storyteller.report_validation_misfit(
                iteration=self.iteration_name, event=None,
                total_sum=True
            )
